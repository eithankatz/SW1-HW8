...
public class FileIndexTester {
	...
	public static void testSortingBySignificance(){
		...
		try{
			...
			TesterUtils.checkDoubleValueAndPrintError(0.0931, res.get(0).getValue(), 0.01, 27);
			TesterUtils.checkDoubleValueAndPrintError(0.0446, res.get(1).getValue(), 0.01, 28);
			TesterUtils.checkDoubleValueAndPrintError(0.0446, res.get(2).getValue(), 0.01, 28);
